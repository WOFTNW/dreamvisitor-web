...
import { ActionIcon, Alert, Badge, Button, Card, Checkbox, Divider, Fieldset, Group, NumberInput, PasswordInput, Space, Switch, Tabs, Text, TextInput, Title } from '@mantine/core';
import { IconServer, IconTool, IconInfoCircle, IconMoneybag, IconEdit } from '@tabler/icons-react';
                        ...
                        <Tabs.Panel value="economy">
                            ...
                            <Card shadow="sm" padding="lg" radius="md" withBorder>
                                <Group justify="space-between" mb="xs">
                                    <Group>
                                        <ActionIcon><IconEdit size='18px' /></ActionIcon>
                                        <Text fw={500}>Insider Perks Tier 1</Text>
                                    </Group>
                                ...
                                <Switch defaultChecked label='Enabled' mt="sm" />
                                <Switch defaultChecked label='Giftable' mt="sm" />
                                <Switch label='Use on Purchase' mt="sm" />

                                <Group mt="sm">
                                    <NumberInput defaultValue="10000.0" label="Price" rightSection="$" />
                                    <NumberInput defaultValue="10" label="Discount" rightSection="%" />
                                </Group>
                                <Group mt="sm">
                                    <NumberInput placeholder="Infinite" label="Max Allowed" />
                                    <NumberInput placeholder="Infinite" label="Available" />
                                </Group>

                                <Button color="green" variant='light' fullWidth mt="md">
                                    Apply
                                </Button>
